...
export const getPostUpdateOrAddLoading = createSelector(
  [selectDomain],
  (state) => state.data.addOrUpdatePost.loading
);
export const getPostUpdateOrAddError = createSelector(
  [selectDomain],
  (state) => state.data.addOrUpdatePost.error
);
