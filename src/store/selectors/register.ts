...
export const getRegisterUser = createSelector([selectDomain], (state) => state.data.user);
...
export const getIsVerified = createSelector([selectDomain], (state) => state.data.isVerified);

export const getIsSentReSend = createSelector([selectDomain], (state) => state.data.isSentReSend);
...
export const getRegisterError = createSelector([selectDomain], (state) => state.error);
...
export const getForgotUserId = createSelector([selectDomain], (state) => state.data.forgotUserId);
